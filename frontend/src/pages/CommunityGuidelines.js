      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-12">
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border border-white/20 relative">
          ...
          <div className="relative p-5 sm:p-8 md:p-10">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-teal-500 mb-5 sm:mb-6 text-center">
            ...
            <div className="space-y-5 sm:space-y-8">
              <div className="bg-white/90 backdrop-blur-sm p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200/50 shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
                  ...
                  <span className="text-base sm:text-xl">Welcome to Our Community</span>
                </h2>
              ...
              <div className="bg-white/90 backdrop-blur-sm p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200/50 shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
                  ...
                  <span className="text-base sm:text-xl">What We Encourage</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4">
                  <div className="flex items-start">
                    <div className="bg-blue-50 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 mt-0.5 flex-shrink-0">
                      <span className="text-blue-600 text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-800 mb-1 text-sm sm:text-base">Honest Opinions</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Share your genuine experiences, both positive and negative</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-green-50 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 mt-0.5 flex-shrink-0">
                      <span className="text-green-600 text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-800 mb-1 text-sm sm:text-base">Detailed Reviews</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Provide specific examples and context for your ratings</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-purple-50 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 mt-0.5 flex-shrink-0">
                      <span className="text-purple-600 text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-800 mb-1 text-sm sm:text-base">Constructive Feedback</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Help future students make informed decisions</p>
                    </div>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-yellow-50 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 mt-0.5 flex-shrink-0">
                      <span className="text-yellow-600 text-xs sm:text-sm font-bold">✓</span>
                    </div>
                    <div>
                      <h3 className="font-medium text-gray-800 mb-1 text-sm sm:text-base">Diverse Perspectives</h3>
                      <p className="text-gray-600 text-xs sm:text-sm">Every student's experience is unique and valuable</p>
                    </div>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-r from-red-50 to-orange-50 border border-red-200/50 p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
                  <div className="bg-red-100 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                    </svg>
                  </div>
                  <span className="text-base sm:text-xl">Our Primary Rule</span>
                </h2>
                <div className="bg-white/80 p-3 sm:p-4 rounded-lg border border-red-200/30">
                  <h3 className="font-bold text-red-700 mb-2 text-sm sm:text-base">No Slandering Other Users</h3>
                  <p className="text-gray-700 mb-3 text-xs sm:text-base">
              ...
              <div className="bg-white/90 backdrop-blur-sm p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200/50 shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
                  ...
                  <span className="text-base sm:text-xl">How to Disagree Respectfully</span>
                </h2>
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-start">
                    <div className="bg-blue-50 p-1 rounded mr-2 sm:mr-3 flex items-center justify-center h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0 mt-0.5">
                      <span className="text-blue-600 text-xs font-bold">1</span>
                    </div>
                    <p className="text-gray-600 text-xs sm:text-base">Share your own experience rather than attacking theirs</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-blue-50 p-1 rounded mr-2 sm:mr-3 flex items-center justify-center h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0 mt-0.5">
                      <span className="text-blue-600 text-xs font-bold">2</span>
                    </div>
                    <p className="text-gray-600 text-xs sm:text-base">Acknowledge that experiences can vary by program, year, or personal circumstances</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-blue-50 p-1 rounded mr-2 sm:mr-3 flex items-center justify-center h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0 mt-0.5">
                      <span className="text-blue-600 text-xs font-bold">3</span>
                    </div>
                    <p className="text-gray-600 text-xs sm:text-base">Use phrases like "In my experience..." or "I had a different experience with..."</p>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-blue-50 p-1 rounded mr-2 sm:mr-3 flex items-center justify-center h-5 w-5 sm:h-6 sm:w-6 flex-shrink-0 mt-0.5">
                      <span className="text-blue-600 text-xs font-bold">4</span>
                    </div>
                    <p className="text-gray-600 text-xs sm:text-base">Focus on the university aspects, not the person who wrote the review</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white/90 backdrop-blur-sm p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200/50 shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
                  <div className="bg-teal-100 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                  ...
                  <span className="text-base sm:text-xl">The Difference</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  <div className="bg-green-50 p-3 sm:p-4 rounded-lg border border-green-200">
                    <h3 className="font-bold text-green-700 mb-2 text-sm sm:text-base">✓ Acceptable</h3>
                    <ul className="space-y-1.5 sm:space-y-2 text-green-600 text-xs sm:text-sm">
                  ...
                  <div className="bg-red-50 p-3 sm:p-4 rounded-lg border border-red-200">
                    <h3 className="font-bold text-red-700 mb-2 text-sm sm:text-base">✗ Not Acceptable</h3>
                    <ul className="space-y-1.5 sm:space-y-2 text-red-600 text-xs sm:text-sm">
              ...
              <div className="bg-white/90 backdrop-blur-sm p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200/50 shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4 flex items-center">
                  ...
                  <span className="text-base sm:text-xl">Reporting and Enforcement</span>
                </h2>
                <p className="text-gray-700 mb-3 sm:mb-4 text-xs sm:text-base">
                ...
                <div className="space-y-2 sm:space-y-3">
                  <div className="flex items-start">
                    ...
                    <span className="text-gray-700 text-xs sm:text-base">Contact our moderation team directly for serious violations</span>
                  </div>
                  <div className="flex items-start">
                    <div className="bg-gray-100 p-1.5 sm:p-2 rounded-lg mr-2 sm:mr-3 flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <span className="text-gray-700 text-xs sm:text-base">Violations may result in content removal and account restrictions</span>
                  </div>
                </div>
              </div>

              <div className="bg-gradient-to-r from-blue-50 to-teal-50 border border-blue-200/50 p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-sm text-center">
