...
const CopyrightPolicy = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      <Helmet>
        <title>Copyright Compliance Policy - RateMyUniversity</title>
        <link rel="canonical" href="https://ratemyuniversity.io/copyright" />
        <meta name="description" content="Copyright Compliance Policy for RateMyUniversity - Learn how to report copyright infringement" />
      </Helmet>

      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -left-20 w-64 sm:w-96 h-64 sm:h-96 rounded-full bg-gradient-to-r from-gray-200 to-transparent opacity-20 blur-3xl"></div>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-48 sm:w-64 h-48 sm:h-64 bg-gradient-to-tr from-gray-100 to-transparent opacity-10 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-4 lg:px-8 py-6 sm:py-12">
        <div className="bg-white/90 backdrop-blur-lg rounded-2xl sm:rounded-3xl shadow-2xl overflow-hidden border border-white/20 relative">
          ...
          <div className="relative p-5 sm:p-8 md:p-10">
            <h1 className="text-xl sm:text-2xl md:text-4xl font-bold text-gray-800 mb-4 sm:mb-6 text-center border-b-2 border-gray-200 pb-3 sm:pb-4">
            ...
            <div className="space-y-5 sm:space-y-8">
              <div className="bg-white p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200 shadow-sm">
                ...
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                  This is the official copyright compliance policy ("Copyright Compliance Policy") for the RateMyUniversity.io website, application or other interactive service ("Site"). The Site is owned, operated and/or provided by RateMyUniversity, LLC ("RateMyUniversity," "we," "us," or "our").
                </p>
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                  This Copyright Compliance Policy is a part of the terms and conditions which are set forth in our Terms of Use Agreement. Any terms that are not defined in this Copyright Compliance Policy shall have the meaning given in the Terms of Use Agreement. Both the Terms of Use Agreement and this Copyright Compliance Policy are legally binding on all users. We take protection of copyrights, both our own and others, very seriously. We therefore employ multiple measures to prevent copyright infringement over this Site and to promptly end any infringement that might occur.
                </p>
              </div>
              ...
              <div className="bg-white p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200 shadow-sm">
                ...
                <h3 className="text-base sm:text-lg font-medium text-gray-800 mb-2 sm:mb-3 mt-4 sm:mt-6">
                  Send your notice of infringement to our email: ratemyuniversitymv@gmail.com
                </h3>
                
                <div className="bg-yellow-50 border-l-4 border-yellow-400 p-3 sm:p-4 mt-4 sm:mt-6">
                  <p className="text-yellow-700 font-medium text-xs sm:text-base">
                ...
                <ol className="list-decimal pl-4 sm:pl-5 text-gray-700 space-y-2 sm:space-y-3 text-sm sm:text-base">
                ...
                <div className="bg-red-50 border-l-4 border-red-400 p-3 sm:p-4 mt-4 sm:mt-6">
                  <p className="text-red-700 font-medium text-xs sm:text-base">
              ...
              <div className="bg-white p-4 sm:p-6 rounded-lg sm:rounded-xl border border-gray-200 shadow-sm">
                <h2 className="text-lg sm:text-xl font-semibold text-gray-800 mb-3 sm:mb-4">
                  HOW TO SEND A COUNTERNOTICE IF YOUR POSTING WAS REMOVED
                </h2>
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed mb-3 sm:mb-4">
                ...
                <p className="text-sm sm:text-base text-gray-700 leading-relaxed mt-4 sm:mt-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-teal-50 border border-blue-200/50 p-4 sm:p-6 rounded-lg sm:rounded-xl shadow-sm text-center">
                <p className="text-gray-700 text-sm sm:text-base">
                  Copyright © 2025 RateMyUniversity - All Rights Reserved.
                </p>
              </div>
            </div>
          </div>
