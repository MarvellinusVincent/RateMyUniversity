      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-white/80 backdrop-blur-lg rounded-3xl shadow-2xl overflow-hidden border border-white/20 relative">
          ...
          <div className="relative flex flex-col md:flex-row">
            <div className="w-full md:w-1/4 bg-gray-50 border-r border-gray-200/50 p-6">
              ...
              <div className="mt-8 p-4 bg-blue-50 rounded-lg border border-blue-200">
                <h3 className="font-medium text-blue-800 mb-2">Still need help?</h3>
                <p className="text-blue-600 text-sm mb-3">Can't find the answer you're looking for?</p>
                <a 
                  href="/contact" 
            ...
            <div className="w-full md:w-3/4 p-6 md:p-8">
              ...
              <p className="text-gray-600 mb-8">Find answers to common questions about RateMyUniversity</p>
              
              <div className="space-y-6">
                {faqData[activeCategory].map((item, index) => (
                  <div key={index} className="bg-white/90 backdrop-blur-sm p-6 rounded-xl border border-gray-200/50 shadow-sm">
