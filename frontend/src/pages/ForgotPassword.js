            ...
            {!emailSent ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <label htmlFor="email" className="block text-sm font-medium text-blue-800/90">Email Address</label>
              ...
              <div className="space-y-6">
                ...
                <div className="text-center text-gray-600">
                  <p className="mb-4">Didn't receive the email? Check your spam folder or try again in a few minutes.</p>
                  <button
                    onClick={() => {
                      setEmailSent(false);
                      setMessage(null);
                    ...
                    className="text-blue-600 hover:text-blue-800 font-medium underline underline-offset-4 transition-colors duration-200"
                  >
                ...
                <button
                  ...
                  className="w-full py-3 px-6 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-lg transition-all duration-300 flex items-center justify-center"
                >
