  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
      <Helmet>
        ...
        />
        <meta name="description" content={`${reviews.length} student reviews of ${university.name} in ${university.country}. Average rating: ${averageRatings.overall.toFixed(1)}/5.0. Read about academics, campus life, safety, and more.`} />
        ...
        <div className="mb-16">
          <div className="flex flex-col sm:flex-row gap-4 max-w-2xl mx-auto">
            <button
              ...
              className="flex-1 bg-gradient-to-r from-blue-600 to-teal-500 hover:from-blue-700 hover:to-teal-600 text-white py-4 px-8 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 bg-white hover:bg-gray-50 border-2 border-gray-200 hover:border-blue-300 text-gray-800 hover:text-blue-600 py-4 px-8 rounded-2xl font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-[1.02] active:scale-95 flex items-center justify-center gap-3"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
